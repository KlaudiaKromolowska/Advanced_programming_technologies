...
public class BookRentalDTO {
    ...
    public static BookRentalDTO create(final int id, final Date rentalDate, final Date returnDate, final UserDTO user){
        final BookRentalDTO newBookRental = new BookRentalDTO();
        newBookRental.setId(id);
        newBookRental.setRentalDate(rentalDate);
        newBookRental.setReturnDate(returnDate);
        newBookRental.setUser(user);
